...
export const allClues: Clues = {
    ...
    clue14:{
        ...
        type: '物品',
        name: '一张连环画',
        content1: '画的内容：一个女生，头发披散跌坐在地上，几个女生围站在她身边，地上是野猫的尸体。这个女生看上去像是春天，难道她们在霸凌她吗？',
        content2: '',
        url: baseUrl + 'clue14',
    },
    clue15:{
    ...
    clue16:{
        ...
        type: '物品',
        name: '一个学生名牌',
        content1: '名牌内容：黄鹂。似乎这个叫黄鹂的女生和白鹭以及其他几人关系都蛮好的。',
        content2: '',
        url: baseUrl + 'clue16',
    },
    clue17:{
    ...
    clue19:{
        ...
        name: '何阑&白鹭',
        content1: '教学楼',
        content2: '春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里春天在哪里',
        url: baseUrl + 'clue19',
    },
    clue20:{
        id: 20,
    ...
    clue28:{
        ...
        type: '物品',
        name: '尹萍的个人线索2',
        content1: '糖果，整个学校只有校长办公室的桌上摆着类似的糖果',
        content2: '',
        url: baseUrl + 'clue28',
    },
    clue29:{
    ...
    clue31:{
        ...
        type: '物品',
        name: '何阑的个人线索2',
        content1: '一条白色的连衣裙，但是有帽子，看上去更像是一件斗篷。斗篷看上去有些脏旧，应该从来没有洗过',
        content2: '',
        url: baseUrl + 'clue31',
    },
    clue32:{
    ...
    clue36:{
        ...
        type: '物品',
        name: '刊登着最新的报纸',
        content1: '80年代打击流氓罪的力度很大，只不过那时对于流氓罪的定义还是“聚众斗殴，寻衅滋事，侮辱妇女或者进行其他流氓活动，破坏公共秩序，处七年以下有期徒刑、拘役或者管制。情节恶劣的，处七年以上有期徒刑或死刑。”',
        content2: '',
        url: baseUrl + 'clue36',
    },
    clue37:{
    ...
    clue46:{
        ...
        type: '物品',
        name: '陈敏的个人线索3',
        content1: '一本字典，男人的衣物和剃须刀。字典上面写着一行字：“Dear my honey” 东西都被装在箱子里，看起来不想让人看到',
        content2: '',
        url: baseUrl + 'clue46',
    },
    clue47:{
